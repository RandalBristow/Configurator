...
export const PreviewGridContainer = ({ columns }) => {
  const title = "Grid";
  return (
    <div className="designer-grid">
      ...
      >
        {columns.map((column) => (
          <div key={column.index} className="designer-grid__column">
            {column.children}
          </div>
        ))}
      </div>
...
export const PreviewRepeaterContainer = ({ component, children }) => {
  ...
  return (
    <div className="designer-repeater">
      ...
      <div className="designer-repeater__body">{children}</div>
    </div>
  );
};

export const PreviewPageContainer = ({ component, children }) => {
  const title =
  ...
  return (
    <div className="designer-page">
      ...
      <div className="designer-page__body">{children}</div>
    </div>
  );
};

export const PreviewStepContainer = ({
  component,
  children,
  stepIndex,
  stepCount,
  ...
  return (
    <div className="designer-step">
      ...
      <div className="designer-step__body">{children}</div>
    </div>
  );
};
...
export const PreviewMultiInstanceStepperContainer = ({ component, steps }) => {
  ...
  return (
    <div className="designer-stepper">
      ...
      {activeStep ? (
        <div className="designer-stepper__body">{activeStep.children}</div>
      ) : (
